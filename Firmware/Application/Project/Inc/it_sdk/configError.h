...
#define APP_ERROR_VICHYDRO_DOWNLINK 	0x00000009 | (ITSDK_ERROR_LEVEL_INFO  | ITSDK_ERROR_TYPE_APP | ITSDK_ERROR_WOUT_VALUE) // Downlink received
#define APP_ERROR_VICHYDRO_INVDLNK 	0x0000000A | (ITSDK_ERROR_LEVEL_WARN  | ITSDK_ERROR_TYPE_APP | ITSDK_ERROR_WOUT_VALUE) // Invalid Downlink received
