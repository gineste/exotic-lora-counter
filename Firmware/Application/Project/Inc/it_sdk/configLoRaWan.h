...
#define ITSDK_LORAWAN_DEVEUI		{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }
																			// Static DEVEUI (big endian)
																		   // Bytes are in the same order as
																		   // in a String.

#define ITSDK_LORAWAN_APPEUI		{ 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x03, 0x6A, 0x8A }
																			// Static APPEUI (big endian)
																		   // Bytes are in the same order as
																		   // in a String.

#define ITSDK_LORAWAN_APPKEY		{ 0xDC, 0xEA, 0xE9, 0x10, 0x06, 0x4F, 0x0E, 0x7B, 0x21, 0xFE, 0x52, 0xDC, 0x67, 0xB8, 0x2E, 0x03 }
																			// Static APPKEY (byte[])
																		   // Bytes are in the same order compared
																		   // as in a String.


#define ITSDK_LORAWAN_NWKKEY		{ 0xDC, 0xEA, 0xE9, 0x10, 0x06, 0x4F, 0x0E, 0x7B, 0x21, 0xFE, 0x52, 0xDC, 0x67, 0xB8, 0x2E, 0x03 }
...
#define ITSDK_LORAWAN_NWKSKEY { 0xC3, 0x01, 0xD5, 0xE2, 0xFF, 0xED, 0xF3, 0x2C, 0xCE, 0x60, 0xB2, 0xD6, 0xF8, 0x91, 0x93, 0x50 }
/*{													\
										0x2B, 0x7E, 0x15, 0x16, 0x28, 0xAE, 0xD2, 0xA6,	\
										0xAB, 0xF7, 0x15, 0x88, 0x09, 0xCF, 0x4F, 0x3C	\
																		   ...
																		   // Bytes are in the same order compared
																		   // as in a String.
#define ITSDK_LORAWAN_APPSKEY		{ 0x26, 0x3E, 0x08, 0x52, 0x45, 0x60, 0xBE, 0x0B, 0x17, 0x57, 0x6E, 0x0A, 0x65, 0xD0, 0x40, 0x39 }
