...
#define ITSDK_LORAWAN_DEVEUI		{ 0x36, 0x33, 0x32, 0x35, 0x4A, 0x38, 0x72, 0x17 }
/*{													\
										0x19, 0x36, 0x69, 0x75, 0x1D, 0x36, 0x69, 0x75	\
...
#define ITSDK_LORAWAN_APPKEY		{ 0x71, 0x1F, 0x86, 0x03, 0x16, 0xAA, 0x49, 0xFA, 0x46, 0xB2, 0x62, 0x10, 0xFF, 0x60, 0x12, 0x20 }
/*{ 0xA6, 0xEB, 0x51, 0xD8, 0xF3, 0xB4, 0x0D, 0xA0, 0x27, 0x98, 0x13, 0x32, 0xA3, 0xB7, 0xA6, 0xA7 }	*/							   // Static APPKEY (byte[])
																		   // Bytes are in the same order compared
																		   // as in a String.


#define ITSDK_LORAWAN_NWKKEY		{ 0x71, 0x1F, 0x86, 0x03, 0x16, 0xAA, 0x49, 0xFA, 0x46, 0xB2, 0x62, 0x10, 0xFF, 0x60, 0x12, 0x20 }							   // Static NETWORK KEY (byte[])
																		   // Bytes are in the same order compared
																		   // as in a String.
